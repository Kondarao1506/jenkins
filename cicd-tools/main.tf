module "jenkins" {
  ...
  vpc_security_group_ids = ["sg-071b3d7ca661a90ab"] #replace your SG
  subnet_id = "subnet-00eb29f075873855c" #replace your Subnet
...
module "jenkins_agent" {
  ...
  instance_type          = "t3.small"
  vpc_security_group_ids = ["sg-071b3d7ca661a90ab"]
